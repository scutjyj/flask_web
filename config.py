...
class Config:
    ...
    ALLOWED_EXTENSIONS = set(['txt', 'pdf', 'png', 'jpg', 'jpeg', 'mp3'])
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql://root:123456@localhost/blog_dev'
...
class TestingConfig(Config):
    ...
    #SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123456@localhost/lagou'
    SQLALCHEMY_DATABASE_URI = 'mysql://root:123456@localhost/blog_test'
