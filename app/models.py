...
class User(UserMixin, db.Model):
    ...
    reset_password_confirmed = db.Column(db.Boolean, default=False)
    ...
    # the field,followd,is the user set that this user is interested at.
    ...
    def reset_password_confirm(self, token):
        s = Serializer(current_app.config['SECRET_KEY'])
        try:
            data = s.loads(token)
        except:
